...
//   This is an API
// Classes:
//   GTLServiceUseritems (0 custom class methods, 0 custom properties)
...
@interface GTLServiceUseritems : GTLService

// No new methods

// Clients should create a standard query with any of the class methods in
// GTLQueryUseritems.h. The query can the be sent with GTLService's execute
// methods,
//
